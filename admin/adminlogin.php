...
<?php
    if(isset($_GET['msgadmin']))
          {
            echo '<h2><span style="color:red;">'.$_GET['msgadmin']. '</span></h2>';
          } 
    if(isset($_GET['msg']))
          {
            echo '<span style="color:red;">'.$_GET['msg']. '</span>';
          }       
    if(isset($_GET['msgadmincheck']))
          {
            echo '<h3><span style="color:red;">'.$_GET['msgadmincheck']. '</span></h3>';
          }       
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="admincheck.php" method="POST">
                            <fieldset>
